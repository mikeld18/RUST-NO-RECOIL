--[[ 
  ...
  FOV -> YOU CAN SET YOUR OWN FOV. YOU HAVE TO GOT TO LINE: 29
____________________________________________________________________________________________
...
____________________________________________________________________________________________
  ...
  EXAMPLE: local AK47_2 = 3 <- MAIN GUN
  EXAMPLE: local AK47_2_HOLOSIGHT = true <- IF YOU WANT TO ADD ATTACHMENTS THEN SWITCH THE /false/ 
  to /true/
____________________________________________________________________________________________
]]
